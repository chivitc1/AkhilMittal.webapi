...
namespace BusinessServices.Tests
{
    public class ProductServicesTests
    {
        ...
        public void Setup()
        {
            ...
            MyAutoMapperHelper.CreateMap<ProductEntity, Product>();
            MyAutoMapperHelper.CreateMap<Product, ProductEntity>();
        }
        ...
        public void GetProductByRightIdTest()
        {
            ...
            {
                var productModel = Mapper.Map<ProductEntity>(mobileProduct);
